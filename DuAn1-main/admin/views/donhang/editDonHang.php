              ...
              <form action="<?= BASE_URL_ADMIN .'?act=sua-don-hang' ?>" method="POST">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="ten_nguoi_nhan" value="<?= $danhMuc['ten_nguoi_nhan'] ?>" placeholder="Nhập tên danh mục">
                    ...
                    <input type="text" class="form-control" name="sdt_nguoi_nhan" value="<?= $danhMuc['sdt_nguoi_nhan'] ?>" placeholder="Nhập tên danh mục">
                    ...
                    <div class="form-group">
                    <label>Email</label>
                    <input type="email" class="form-control" name="email_nguoi_nhan" value="<?= $danhMuc['email_nguoi_nhan'] ?>" placeholder="Nhập tên danh mục">
                    ...
                    <div class="form-group">
                    <label>Địa chỉ</label>
                    <input type="text" class="form-control" name="dia_chi_nguoi_nhan" value="<?= $danhMuc['dia_chi_nguoi_nhan'] ?>" placeholder="Nhập tên danh mục">
                   ...
                   <div class="form-group">
                    <label>Ghi chú</label>
                    <textarea name="ghi_chu" id="" class="form-control" placeholder="Nhập mô tả"><?= $danhMuc['ghi_chu'] ?></textarea>
                  </div>
